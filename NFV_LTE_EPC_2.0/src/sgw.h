...
#include "utils.h"
extern int g_sgw_rep_port;
extern vector<UdpClient> sgw_rep1_clients;
extern vector<UdpClient> sgw_rep2_clients;
...
extern string g_sgw_rep1_ip;
extern string g_sgw_rep2_ip;


//const string dssgw_path = "10.129.26.50:8090";
//const string dssgw_path = "10.129.28.44:7001";
const string dssgw_path = PDS;
...
public:
	...
	void send_replication(int,Sgw_state ,uint32_t ,uint32_t ,uint32_t,uint64_t ,int);

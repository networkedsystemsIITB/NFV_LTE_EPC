/*
 ...
 //RAMCloud
 g++ -std=c++11 -O3 KVRequest.cpp -L../Implementation/RAMCloud/RAMCloud/install/lib/ramcloud/ -lkvstore -lboost_serialization -pthread -lkvs_ramcloud -lramcloud -lprotobuf -lpcrecpp -lboost_system -lzookeeper_mt
